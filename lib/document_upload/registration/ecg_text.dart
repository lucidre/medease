...
class EcgTestScreen extends StatefulWidget {
  final String ecgTest;
  ...
  @override
  _EcgTestScreenState createState() => _EcgTestScreenState();
}

class _EcgTestScreenState extends State<EcgTestScreen> {
  String _ecgTest = '';

  @override
  void initState() {
    super.initState();
    _ecgTest = widget.ecgTest;
  }
          ...
          children: [
            ...
            Text(
              ...
              style: bodyText2!.copyWith(
                  color: _ecgTest.isEmpty ? Colors.red : Colors.blueAccent),
            ),
            const SizedBox(
              width: 3,
            ),
            Row(
              ...
              children: [
                widget.ecgTest.isNotEmpty
                    ? IconButton(
                        onPressed: () {
                          widget.downloadFile(widget.ecgTest, 'ECG Test');
                        },
                        icon: const Icon(
                          Icons.download,
